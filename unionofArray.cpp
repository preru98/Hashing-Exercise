/*
Problem :
    Given two arrays size m and size n, find union of them. 
Solution : 
...
void get_union(int[],int,int[],int);
...
int main(){
    ...
    cout<<"\nUnion   : ";
    get_union(array1,size1,array2,size2);
...
void get_union(int array1[],int size1, int array2[],int size2){
